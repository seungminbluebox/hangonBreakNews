        ...
        "schema": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "importance_score": {"type": "number", "minimum": 7, "maximum": 10},
                    "category": {
                        "type": "string",
...
ANALYSIS_ONLY_SOURCE_IDS = {"simplywall.st"}
...
def select_and_summarize(
    ...
    *,
    ...
    candidate_indexes = [
        ...
        if article.get("source_id") not in ANALYSIS_ONLY_SOURCE_IDS
    ...
    for start in range(0, len(candidate_indexes), batch_size):
        ...
        response_text = _response_text(generator(_selection_prompt(candidates)))
        decisions.extend(_load_decisions(response_text, generator))
    ...
    for decision in decisions:
        ...
        if (
            ...
            or temp_id in seen_ids
            or not 0 <= temp_id < len(articles)
