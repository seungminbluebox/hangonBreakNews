...
- 중요도(importance_score): 글로벌 경제/증시/지정학/주요 기업 파급력에 따라 1~10점으로 부여하되, 경제/증시와 무관한 가십성 기사만 0점을 주고 제외하세요. **유의미한 경제/증시/기업/암호화폐/지정학 뉴스일 경우 기본적으로 7점 이상**을 부여하여 적극적으로 통과시키세요.
